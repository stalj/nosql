...
# Task 1: Building Nested JSON Structure
...
2. Add `products` array containing at least 3 objects. Each product object must include:
...
# Task 6: Validating Complex Structures
